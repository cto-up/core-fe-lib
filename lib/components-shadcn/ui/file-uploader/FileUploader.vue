<template>
  <div class="file-uploader">
    ...
    >
      <template #content>
        <div class="file-display p-4 rounded-lg bg-muted">
          <div class="flex items-center justify-between gap-4">
            <div class="flex items-center gap-4 flex-1 min-w-0">
              <div class="file-icon text-primary flex-shrink-0">
              ...
              <div class="file-details flex-1 min-w-0">
                <div class="file-name font-semibold truncate">
                  {{ selectedFileName }}
                </div>
                <div class="file-meta text-sm text-muted-foreground flex gap-3">
    ...
    await axios({
      ...
      onUploadProgress: (progressEvent) => {
        if (progressEvent.total) {
          ...
          message.value = `Uploading... ${Math.round(progress.value * 100)}%`;
        }
      },
    });
